...
import Bytovye from "../images/photo-1-bytovye.png";

const HomerConditioner = () => {
  return (
    <motion.div exit="out" animate="in" initial="initial" variants={PageVariants} transition={PageTransitions} className="container">
      
      <section className="block-main block-bg-img block-full-height block-flexbox" style={{ backgroundImage: `url(${BytovyeBackground})` }}>
        {/* <PhantomNavbar/> */}
      ...
      <section className="block-main">
        <div className="block-inside-wrapper inside-page">
          <h1 className="text-main black">УСЛУГИ ПО БЫТОВЫМ КОНДИЦИОНЕРАМ</h1>
...
export default HomerConditioner;
